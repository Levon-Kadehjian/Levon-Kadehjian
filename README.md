...
<div style="display: flex; justify-content: center; margin-top: 20px;">
  <table style="text-align: center;">
    <tr>
      <td style="text-align: center;">
        ...
        <a href="https://skillicons.dev">
          <img src="https://skillicons.dev/icons?i=html,css,react,spring,mysql,nodejs,npm&theme=dark" alt="Web Skills">
        </a>
      </td>
      <td style="text-align: center;">
      ...
      <td style="text-align: center;">
        <h2 style="text-align: center;">🔧 Tools & Version Control </h2>
        <a href="https://skillicons.dev">
    ...
    <tr>
      <td style="text-align: center;">
        <h2 style="text-align: center;">🖥️ OS </h2>
        <a href="https://skillicons.dev">
          <img src="https://skillicons.dev/icons?i=apple,windows,linux,ubuntu&theme=dark" alt="Operating Systems">
        </a>
      </td>
      <td style="text-align: center;">
        <h2 style="text-align: center;">🛠️ IDEs </h2>
        <a href="https://skillicons.dev">
          <img src="https://skillicons.dev/icons?i=vscode,idea,pycharm,webstorm&theme=dark" alt="IDEs">
        </a>
      </td>
      <td style="text-align: center;">
        <h2 style="text-align: center;">📄 Docs </h2>
        <a href="https://skillicons.dev">
          <img src="https://skillicons.dev/icons?i=latex&theme=dark" alt="Docs">
        </a>
      </td>
    </tr>
  </table>
